...
> **features**: [`vector`](vector.md)\<[`chatBoostLevelFeatures`](chatBoostLevelFeatures.md)\>

The list of features

### min\_background\_custom\_emoji\_boost\_level

> **min\_background\_custom\_emoji\_boost\_level**: [`int32`](int32.md)
