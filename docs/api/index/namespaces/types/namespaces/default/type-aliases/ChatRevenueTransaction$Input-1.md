...
> **ChatRevenueTransaction$Input**: [`chatRevenueTransaction$Input`](chatRevenueTransaction$Input.md)

Version of [ChatRevenueTransaction](ChatRevenueTransaction-1.md) for method parameters.
Any of:
- [chatRevenueTransaction$Input](chatRevenueTransaction$Input.md)

## Defined in

dist/generated/types.d.ts:67866
