...
> **AvailableReactions$Input**: [`availableReactions$Input`](availableReactions$Input.md)

Version of [AvailableReactions](AvailableReactions-1.md) for method parameters.
Any of:
- [availableReactions$Input](availableReactions$Input.md)

## Defined in

dist/generated/types.d.ts:65499
